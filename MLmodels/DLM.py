...
class DLM(Exp_Basic):
    ...
    def predict(self, setting, load=False):
        ...
        # print(f"pred_data.future_Dates: {pred_data.future_dates}")
        df_preds = pd.DataFrame(np.append(np.transpose([pred_data.future_dates]), preds, axis=1), columns=pred_data.cols)
